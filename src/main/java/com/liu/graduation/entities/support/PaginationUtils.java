...
public class PaginationUtils {
	 public static List<Pagination> pagination(int limit, int index, int disp) {
	        ...
	        if(last < index) return PaginationUtils.pagination(1, 1, disp);
	        ...
	        if(index != 1) paginations.add(new Pagination(1, "&laquo;", null));
	        if(index > 1) paginations.add(new Pagination(index - 1, "&larr;", null));
	        ...
	        if(index < last) paginations.add(new Pagination(index + 1, "&rarr;", null));
	        if(index != last) paginations.add(new Pagination(last, "&raquo;", null));
